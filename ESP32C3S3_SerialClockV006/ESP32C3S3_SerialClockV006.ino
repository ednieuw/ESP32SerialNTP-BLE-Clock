...
USB-CDC on boot: EMABLED
              
*/
// =============================================================================================================================
//#define ESP32C3_SUPERMINI
//#define ESP32C3_DEV         //(12F)
//#define ESP32S3_DEV
//#define NanoESP32
#define ESP32S3_ZERO
//--------------------------------------------                                                //
...
void setup() 
{
 ...
 Serial1.begin(9600, SERIAL_8N1, 5, 4);                                                       // Serial1.begin(9600, SERIAL_8N1, RX1PIN, TX1PIN);                                            // Setup the serial port to 115200 baud //
 ...
 SetStatusLED(0,0,255,0,0);                                                                   // Set the status LED to red
...
void UpdateStatusLEDs(bool Toggle)
{
 if (Mem.StatusLEDOnOff)   
     {
   if(Toggle) SetStatusLED(0,0,0,WIFIConnected*255,deviceConnected*255); 
    else SetStatusLED(0,0,0,0,0);
             ...
             if(InputString.length() == 1)
               {
                ...
                if (Mem.StatusLEDOnOff )SetStatusLED(0,0,0,0,0); 
